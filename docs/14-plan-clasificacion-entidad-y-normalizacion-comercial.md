...
- [ ] **I-004 Incorporar `is_target_entity` como decisión explícita**
...
- [ ] **I-005 Añadir penalizaciones fuertes para medios, listados y comparadores**
...
- [ ] **I-006 Separar `quality_status` de `acceptance_decision`**
...
- [ ] **I-007 Rebalancear pesos del score**
...
- [ ] **I-008 Validar consistencia entre dominio del sitio y dominio del email**
...
- [ ] **I-009 Endurecer validación de teléfono**
...
- [ ] **I-010 Añadir confianza por canal de contacto**
  - `primary_email_confidence`
  - `primary_phone_confidence`
